...
class OpStudent(models.Model):
    ...
    count_sale_order = fields.Integer(related='partner_id.sale_order_count')


    # @api.depends('partner_id')
    # def _count_sale_order(self):
    #     for record in self:
    #         record.count_sale_order = self.env['sale.order'].search_count(
    #             [('partner_id', '=', record.partner_id)]
    #         )
            # record.count_sale_order = len(sale_order)
