...
class HrEmployeeFamilyInfo(models.Model):
    ...
    relation = fields.Selection([('father', 'Bố'),
                                 ('mother', 'Mẹ'),
                                 ('daughter', 'Con gái'),
                                 ('son', 'Con trai'),
                                 ('wife', 'Vợ'),
                                 ('husband', 'Chồng'),
                                 ('other', 'Khác')], string='Relationship', help='Relation with employee')
    member_contact = fields.Char(string='Contact No')
    date_of_birth = fields.Char(string='Ngày sinh')
...
class HrEmployee(models.Model):
    ...
    joining_date = fields.Date(string='Ngày gia nhập')
    ...
    mst_account_id = fields.Char('MST cá nhân')
