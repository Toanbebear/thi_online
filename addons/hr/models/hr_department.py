...
class Department(models.Model):
    ...
    parent_id = fields.Many2one('hr.department', string='Parent Department', index=True, domain="[('company_id', '=', company_id), ('id', '!=', id)]", ondelete='cascade')
    child_ids = fields.One2many('hr.department', 'parent_id', string='Child Departments')
    manager_id = fields.Many2one('hr.employee', string='Manager', tracking=True, domain="[('company_id', '=', company_id)]")
