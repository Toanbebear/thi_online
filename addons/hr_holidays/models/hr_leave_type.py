...
class HolidaysType(models.Model):
    ...
    validation_type = fields.Selection([
        ('no_validation', 'Không xác thực'),
        ('hr', 'Cán bộ HR'),
        ('manager', 'Trưởng nhóm'),
        ('both', 'Trưởng nhóm và cán bộ HR')], default='hr', string='Validation')
    allocation_type = fields.Selection([
        ('no', 'Không cần cấp phát'),
        ('fixed_allocation', 'Cấp phát miễn phí'),
        ('fixed', 'Chỉ do HR cấp phát')],
