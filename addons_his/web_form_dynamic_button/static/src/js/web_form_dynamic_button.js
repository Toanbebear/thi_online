        ...
        _updateButtons: function () {
            ...
            if (this.mode === 'readonly' && this.$buttons && this.hasButtons) {
                ...
                _.each(actions, function (action) {
                    ...
                    if(action == 'create'){
                        self.$buttons.find('.o_field_x2many_list_row_add').toggleClass('o_hidden', !act_res);
                    }
                });

                var expr_del = attrs['delete_expr'];
                var act_res_del = expr_del ? self._evalActionExpr(expr_del) : self.activeActions['delete'];
                self.$buttons.find('.o_list_record_remove').toggleClass('o_hidden', !act_res_del);
            }
        },
        /**
