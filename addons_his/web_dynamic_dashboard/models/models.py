...
class Dashboard(models.Model):
    ...
    def write(self, vals):
        ...
        for record in self:
            ...
            elif record.id and 'parent_menu_id' in vals and not record.parent_menu_id and record.menu_id:
