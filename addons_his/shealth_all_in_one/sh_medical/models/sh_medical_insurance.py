...
class SHealthInsurance(models.Model):
    ...
    patient = fields.Many2one('sh.medical.patient', string='Bệnh nhân', required=True)
    ...
    state = fields.Selection(STATE, string='Trạng thái', readonly=True, copy=False, help="Status of insurance", default=lambda *a: 'Draft')
