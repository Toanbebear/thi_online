...
class AssetDepreciationConfirmationWizard(models.TransientModel):
    ...
    date = fields.Date('Ngày Kế toán', required=True, help="Choose the period for which you want to automatically post the depreciation lines of running assets", default=fields.Date.context_today)
